  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      data.transactions = data.transactions.map((transaction: any) => {
        const created_at = parseISO(transaction.created_at);
        const formattedDate = format(created_at, 'dd/MM/yyyy');
        const formattedValue = formatValue(Number(transaction.value));
        return { ...transaction, created_at, formattedDate, formattedValue };
      });
